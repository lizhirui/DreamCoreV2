...
namespace DreamCoreV2_model_controller.Model
{
    ...
    public class ExecuteWBOPInfo
    {
        ...
        public bool BRUJump { get; set; }
        [JsonProperty("bru_next_pc")]
        public uint BRUNextPC { get; set; }
        [JsonProperty("rs1")]
        ...
        public uint Src1Value { get; set; }
        [JsonProperty("src1_loaded")]
        public bool Src1Loaded { get; set; }
        [JsonProperty("rs2")]
        ...
        public uint Src2Value { get; set; }
        [JsonProperty("src2_loaded")]
        public bool Src2Loaded { get; set; }
        [JsonProperty("rd")]
        ...
        [JsonProperty("rd_value")]
        public uint RDValue { get; set; }
        [JsonProperty("csr")]
