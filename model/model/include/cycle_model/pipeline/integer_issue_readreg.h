...
{
    typedef struct integer_issue_readreg_op_info_t
    {
    ...
    }integer_issue_readreg_op_info_t;
    
    typedef struct integer_issue_readreg_pack_t : public if_print_t
    {
        integer_issue_readreg_op_info_t op_info[INTEGER_ISSUE_WIDTH];
