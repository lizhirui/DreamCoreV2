...
namespace cycle_model::pipeline
{
    ...
    }lsu_issue_feedback_pack_t;
    
    class lsu_issue : public if_print_t, public if_reset_t
    {
        private:
            typedef struct issue_queue_item_t : public if_print_t
            {
                ...
                virtual json get_json()
                {
                    ...
                    t["rd_phy"] = rd_phy;
                    t["csr"] = csr;
                    t["store_buffer_id"] = this->store_buffer_id;
                    t["load_queue_id"] = this->load_queue_id;
                    t["op"] = outenum(op);
