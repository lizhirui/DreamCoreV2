...
namespace pipeline
{
    ...
    class rename : public if_reset_t
    {
        ...
        public:
            rename(component::fifo<decode_rename_pack_t> *decode_rename_fifo, component::port<rename_issue_pack_t> *rename_issue_port, component::rat *speculative_rat, component::rob *rob);
            virtual void reset();
