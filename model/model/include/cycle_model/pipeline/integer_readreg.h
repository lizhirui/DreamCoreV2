...
namespace cycle_model::pipeline
{
    class integer_readreg : public if_reset_t
    {
        ...
        public:
            ...
            virtual void reset();
            void run(const execute::bru_feedback_pack_t &bru_feedback_pack, const execute_feedback_pack_t &execute_feedback_pack, const wb_feedback_pack_t &wb_feedback_pack, const commit_feedback_pack_t &commit_feedback_pack);
    };
}