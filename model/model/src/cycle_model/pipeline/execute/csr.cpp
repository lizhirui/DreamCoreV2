...
namespace pipeline
{
    namespace execute
    {
        csr::csr(uint32_t id, component::handshake_dff<readreg_execute_pack_t> *readreg_csr_hdff, component::port<execute_wb_pack_t> *csr_wb_port, component::csrfile *csr_file) : tdb(TRACE_EXECUTE_CSR)
        {
            this->id = id;
