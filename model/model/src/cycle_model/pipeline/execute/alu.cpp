...
namespace pipeline
{
    namespace execute
    {
        alu::alu(uint32_t id, component::handshake_dff<readreg_execute_pack_t> *readreg_alu_hdff, component::port<execute_wb_pack_t> *alu_wb_port) : tdb(TRACE_EXECUTE_ALU)
        {
            this->id = id;
