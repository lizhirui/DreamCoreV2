...
namespace pipeline
{
    namespace execute
    {
        bru::bru(uint32_t id,component::handshake_dff<readreg_execute_pack_t> *readreg_bru_hdff, component::port<execute_wb_pack_t> *bru_wb_port, component::csrfile *csr_file) : tdb(TRACE_EXECUTE_BRU)
        {
            this->id = id;
        ...
        void bru::run(commit_feedback_pack_t commit_feedback_pack)
        {
